...
jsPsych.plugins['survey-multi-select'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    var cssstr = 
      ...
      ".jspsych-survey-multi-select-option { text-align: center; line-height: 2; }"+
    ...
    trial_form.innerHTML += '<button id="'+plugin_id_name+'-next" class="'+plugin_id_name+' jspsych-btn" style="margin-bottom:50px">'+trial.button_label+'</button>';
